          ...
          <ul class="nav navbar-nav">
            <li class="dropdown">
              ...
              <ul class="nav dropdown-menu">
                <li><a href="login1.php?attemp=2" style="color: #D9534F;">Vulnerable</a></li>
                <li><a href="login2.php?attempt=2" style="color: #5CB85C;">Secure</a></li>
              </ul>
            </li>
          <li class="dropdown">
            ...
            <li class="dropdown">
              ...
              <ul class="nav dropdown-menu">
                <li><a href="books1.php?attempt=2" style="color: #D9534F;">Vulnerable</a></li>
                <li><a href="books2.php?attempt=2" style="color: #5CB85C;">Secure</a></li>
              </ul>
            </li>
            <li class="dropdown">
