        ...
        <div class="col-sm-offset-2 col-sm-8">
          <form class="form-horizontal" role="form" action="regexp.php" method="GET">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input value="<?php echo $pattern ?>" name="pattern" type="text" class="form-control" id="inputEmail3" placeholder="enter a regular expression between / and /">
              </div>
            </div>
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">Subject</label>
              <div class="col-sm-8">
                <input value="<?php  echo $subject ?>" name="subject" type="text" class="form-control" id="inputPassword3" placeholder="enter a string">
              </div>
            </div>
            <div class="form-group">
